...
/* harmony export */   "THREE_MESH_BVH": () => (/* reexport module object */ three_mesh_bvh__WEBPACK_IMPORTED_MODULE_20__),
...
/* harmony import */ var three_mesh_bvh__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! three-mesh-bvh */ "./node_modules/three-mesh-bvh/src/index.js");
...
/* harmony import */ var _croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! @croquet/worldcore-kernel */ "./node_modules/@croquet/worldcore-kernel/index.js");
...
//-- ThreeVisible  -------------------------------------------------------------------------
//------------------------------------------------------------------------------------------
const PM_ThreeVisible = superclass => class extends (0,_croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_18__.PM_Visible)(superclass) {
...
const PM_ThreeCamera = superclass => class extends (0,_croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_18__.PM_Camera)(superclass) {
    constructor(...args) {
        super(...args);
...
class ThreeRenderManager extends _croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_18__.RenderManager {
...
class AvatarPawn extends (0,_croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.mix)(_card_js__WEBPACK_IMPORTED_MODULE_4__.CardPawn).with(_croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.PM_Player, PM_SmoothedDriver, _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.PM_ThreeVisible, _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.PM_ThreeCamera, _Pointer_js__WEBPACK_IMPORTED_MODULE_3__.PM_Pointer) {
    constructor(actor) {
        ...
        this.walkCamera = new _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.THREE.Object3D();

        this.walkcaster = new _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.THREE.Raycaster(new _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.THREE.Vector3(), new _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.THREE.Vector3(0, - 1, 0));
        ...
        (0,_worldMenu_js__WEBPACK_IMPORTED_MODULE_5__.filterDomEventsOn)(document.getElementById("homeBttn"));
        document.getElementById("usersComeHereBttn").onclick = () => this.comeToMe();
        (0,_worldMenu_js__WEBPACK_IMPORTED_MODULE_5__.filterDomEventsOn)(document.getElementById("usersComeHereBttn"));
    ...
    setAvatarModel(url) {
        this.getBuffer(url).then((buffer) => {
            let assetManager = this.service("AssetManager").assetManager;
            return assetManager.load(buffer, "glb", _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.THREE, {});
        }).then((obj) => {
            let found = false;
            obj.traverse((mesh) => {
                if (mesh.isBone) {
...
class CardPawn extends (0,_croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.mix)(_croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.Pawn).with(_croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.PM_Smoothed, _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.PM_ThreeVisible, _Pointer_js__WEBPACK_IMPORTED_MODULE_2__.PM_PointerTarget, _code_js__WEBPACK_IMPORTED_MODULE_6__.PM_Code) {
    ...
    construct3D(options) {
        ...
        this.getBuffer(model3d).then((buffer) => {
            ...
            (0,_assetManager_js__WEBPACK_IMPORTED_MODULE_3__.addShadows)(obj, shadow, singleSided, _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.THREE);
...
class ScriptingBehavior extends Model {
    ...
    setCode(string) {
        ...
        let cls;
        try {
            const Microverse = {..._croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__, ..._ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__, ..._physics_js__WEBPACK_IMPORTED_MODULE_2__};
...
/* harmony import */ var _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ThreeRender.js */ "./src/ThreeRender.js");
/* harmony import */ var _physics_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./physics.js */ "./src/physics.js");
/* harmony import */ var _text_text_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./text/text.js */ "./src/text/text.js");
/* harmony import */ var _card_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./card.js */ "./src/card.js");
/* harmony import */ var _avatar_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./avatar.js */ "./src/avatar.js");
/* harmony import */ var _frame_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./frame.js */ "./src/frame.js");
/* harmony import */ var _code_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./code.js */ "./src/code.js");
/* harmony import */ var _portal_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./portal.js */ "./src/portal.js");
/* harmony import */ var _worldSaver_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./worldSaver.js */ "./src/worldSaver.js");
/* harmony import */ var _apps_multiblaster_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../apps/multiblaster.js */ "./apps/multiblaster.js");
...
/* harmony import */ var _wcAssetManager_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./wcAssetManager.js */ "./src/wcAssetManager.js");
// Copyright 2022 by Croquet Corporation, Inc. All Rights Reserved.
// https://croquet.io
// info@croquet.io
...
function loadInitialBehaviors(paths, directory) {
    let library = _croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.Constants.Library || new _code_js__WEBPACK_IMPORTED_MODULE_7__.CodeLibrary();
    ...
    return Promise.all(promises).then((array) => {
        array.forEach((pair) => {
            ...
            (0,_code_js__WEBPACK_IMPORTED_MODULE_7__.checkModule)(module); // may throw an error
...
class MyPlayerManager extends _croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.PlayerManager {
    ...
    createPlayer(playerOptions) {
        ...
        console.log((0,_frame_js__WEBPACK_IMPORTED_MODULE_6__.frameName)(), "MyPlayerManager", this.avatarCount);
        ...
        return _avatar_js__WEBPACK_IMPORTED_MODULE_5__.AvatarActor.create(options);
    }
    ...
    continuePresenting(presenter, presenterToken) {
        ...
        if (!this.presentationMode) {
            console.log((0,_frame_js__WEBPACK_IMPORTED_MODULE_6__.frameName)(), "continuePresenting", presenter.id, presenterToken);
            ...
            console.log((0,_frame_js__WEBPACK_IMPORTED_MODULE_6__.frameName)(), "continuePresenting rejected due to presentation in progress");
        }
    }
    ...
    continueFollowing(follower, presenterToken) {
        ...
        if (this.presentationMode && this.presenter.presenterToken === presenterToken) {
            console.log((0,_frame_js__WEBPACK_IMPORTED_MODULE_6__.frameName)(), "continueFollowing", this.presenter.id, presenterToken);
            this.followers.add(follower.playerId);
            follower.presentationStarted();
            this.publish("playerManager", "playerCountChanged");
        } else {
            follower.presenterToken = presenterToken;
            console.log((0,_frame_js__WEBPACK_IMPORTED_MODULE_6__.frameName)(), "continueFollowing: expected presenter not presenting", presenterToken);
        }
    }

    playerEnteredWorld(player) {
        console.log((0,_frame_js__WEBPACK_IMPORTED_MODULE_6__.frameName)(), "playerEnteredWorld", player);
        this.publish("playerManager", "playerCountChanged");
    }

    playerLeftWorld(player) {
        console.log((0,_frame_js__WEBPACK_IMPORTED_MODULE_6__.frameName)(), "playerLeftWorld", player);
...
class MyModelRoot extends _croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.ModelRoot {
    static modelServices() {
        return [
            MyPlayerManager,
            _card_js__WEBPACK_IMPORTED_MODULE_4__.MicroverseAppManager,
            _code_js__WEBPACK_IMPORTED_MODULE_7__.BehaviorModelManager,
            _text_text_js__WEBPACK_IMPORTED_MODULE_3__.FontModelManager,
    ...
    init(options, persistentData) {
        ...
        appManager.add(_apps_multiblaster_js__WEBPACK_IMPORTED_MODULE_10__.MultiBlaster);
        appManager.add(_text_text_js__WEBPACK_IMPORTED_MODULE_3__.TextFieldActor);
        appManager.add(_portal_js__WEBPACK_IMPORTED_MODULE_8__.PortalActor);
    ...
    loadPersistentData({ _name, version, data }) {
        try {
            ...
            let saver = new _worldSaver_js__WEBPACK_IMPORTED_MODULE_9__.WorldSaver(_card_js__WEBPACK_IMPORTED_MODULE_4__.CardActor);
    ...
    load(cards, version) {
        if (version === "1") {
            return _card_js__WEBPACK_IMPORTED_MODULE_4__.CardActor.load(cards, this, version);
        }
    }
...
class MyViewRoot extends _croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.ViewRoot {
    static viewServices() {
        return [
            ...
            _wcAssetManager_js__WEBPACK_IMPORTED_MODULE_12__.AssetManager,
            _text_text_js__WEBPACK_IMPORTED_MODULE_3__.KeyFocusManager,
            _text_text_js__WEBPACK_IMPORTED_MODULE_3__.FontViewManager,
            _text_text_js__WEBPACK_IMPORTED_MODULE_3__.SyncedStateManager,
            _card_js__WEBPACK_IMPORTED_MODULE_4__.VideoManager,
            _code_js__WEBPACK_IMPORTED_MODULE_7__.BehaviorViewManager,
        ];
    }
    constructor(model) {
        super(model);
...
async function startMicroverse() {
    ...
    if (!basename.endsWith(".vrse")) {
        ...
        const json = new _worldSaver_js__WEBPACK_IMPORTED_MODULE_9__.WorldSaver().parse(text);
        ...
        _croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.Constants.Library = new _code_js__WEBPACK_IMPORTED_MODULE_7__.CodeLibrary();
...
class PortalPawn extends _card_js__WEBPACK_IMPORTED_MODULE_2__.CardPawn {
    constructor(actor) {
        ...
        this.targetMatrix = new _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.THREE.Matrix4();
        this.targetMatrixBefore = new _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.THREE.Matrix4();
    ...
    get globalPlane() {
        if (!this._globalPlane) {
            this._globalPlane = new _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.THREE.Plane();
    ...
    createPortalMaterials() {
        ...
        this.portalMaterial = new _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.THREE.ShaderMaterial({
    ...
    addParticles() {
        ...
        const uniforms = {
            pointTexture: { value: new _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.THREE.TextureLoader().load( './assets/images/spark.png' ) }
        };
        const shaderMaterial = new _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.THREE.ShaderMaterial( {
            uniforms,
            vertexShader: `
            ...
            `,
            clipping: true,
            blending: _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.THREE.AdditiveBlending,
            depthWrite: false,
            transparent: true,
            vertexColors: true
        } );
        ...
        const geometry = new _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.THREE.BufferGeometry();
        geometry.setAttribute( 'position', new _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.THREE.Float32BufferAttribute( positions, 3 ) );
        geometry.setAttribute( 'size', new _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.THREE.Float32BufferAttribute( sizes, 1 ).setUsage( _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.THREE.DynamicDrawUsage ) );

        this.particleSystem = new _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.THREE.Points( geometry, shaderMaterial );
    ...
    updatePortalCamera(callback, force) {
        ...
        if (force || !targetMatrixBefore.equals(targetMatrix)) {
            const frustum = new _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.THREE.Frustum();
            const matrix = new _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.THREE.Matrix4().multiplyMatrices(camera.projectionMatrix, camera.matrixWorldInverse);
